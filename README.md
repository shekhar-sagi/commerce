...
## Environments
- Preview: https://main--commerce--shekhar-sagi.aem.page/
- Live: https://main--commerce--shekhar-sagi.aem.live/
...
1. Open the `commerce` directory in your favourite IDE and start coding :)
